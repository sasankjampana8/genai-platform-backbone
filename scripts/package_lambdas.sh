...
package_lambda "v1_documents_handler" "v1_documents_handler.zip"
package_lambda "memory_handler" "memory_handler.zip"
package_lambda "chat_handler" "chat_handler.zip"
package_lambda "runtime_worker" "runtime_worker.zip"
package_lambda "run_handler" "run_handler.zip"
